...
using TMPro;
    ...
    public class LynxVirtualKeyboard_Leap : MonoBehaviour
{
        public static LynxVirtualKeyboard_Leap Instance { get; private set; }
        ...
        /// (Cleared when keyboard is closed.)
        /// </summary>
        public event Action<GameObject, string> OnTextUpdated = delegate { };
        ...
        /// </summary>
        public GameObject AlphaKeyboard = null;

        /// <summary>
        /// The panel that contains the number and symbol keys.
        /// </summary>
        public GameObject SymbolKeyboard = null;

        /// <summary>
        /// References abc bottom panel.
        /// </summary>
        public GameObject AlphaSubKeys = null;

        /// <summary>
        /// References .com bottom panel.
        /// </summary>
        public GameObject AlphaWebKeys = null;

        /// <summary>
        /// References @ bottom panel.
        /// </summary>
        public GameObject AlphaMailKeys = null;

        private GameObject activeInputField = null;
        ...
        // 03/11/2021 : cedric, en fait rect = null, j'ai donc enlevé cette partie qui semble inutile.  
        /*    
        Debug.Log("Awake 2");
        ...
        */
        ...
        private void DoTextUpdated(string value) => OnTextUpdated?.Invoke(activeInputField,value);
        ...
        {
            float distance = (transform.position - Camera.main.transform.position).magnitude; // cedric 20/07/2020 : replace CameraCache.Main by Camera.main
        ...
        {
            transform.LookAt(Camera.main.transform.position); // cedric 20/07/2020 : replace CameraCache.Main by Camera.main
        ...
        public void setActiveInputField(GameObject gameobject)
        {
        ...
        public void AppendValue(string normalValue, string shiftValue)
        {
            IndicateActivity();
            string value = "";

            // Shift value should only be applied if a shift value is present.
            if (m_IsShifted && !string.IsNullOrEmpty(shiftValue))
            {
                value = shiftValue;
            }
            else
        ...
        public void FunctionKey(KeyboardKeyFunc_Leap functionKey)
        {
            IndicateActivity();
            switch (functionKey.ButtonFunction)
            {
                case KeyboardKeyFunc_Leap.Function.Enter:
                    {
                        Enter();
                        break;
                    }

                case KeyboardKeyFunc_Leap.Function.Tab:
                    {
                        Tab();
                        break;
                    }

                case KeyboardKeyFunc_Leap.Function.ABC:
                    {
                        ActivateSpecificKeyboard(m_LastKeyboardLayout);
                        break;
                    }

                case KeyboardKeyFunc_Leap.Function.Symbol:
                    {
                        ActivateSpecificKeyboard(LayoutType.Symbol);
                        break;
                    }

                case KeyboardKeyFunc_Leap.Function.Previous:
                    {
                        MoveCaretLeft();
                        break;
                    }

                case KeyboardKeyFunc_Leap.Function.Next:
                    {
                        MoveCaretRight();
                        break;
                    }

                case KeyboardKeyFunc_Leap.Function.Close:
                    {
                        Close();
                        break;
                    }
                ...
                case KeyboardKeyFunc_Leap.Function.Shift:
                    {
                        Shift(!m_IsShifted);
                        break;
                    }

                case KeyboardKeyFunc_Leap.Function.CapsLock:
                    {
                        CapsLock(!m_IsCapslocked);
                        break;
                    }

                case KeyboardKeyFunc_Leap.Function.Space:
                    {
                        Space();
                        break;
                    }

                case KeyboardKeyFunc_Leap.Function.Backspace:
                    {
                        Backspace();
                        break;
                    }

                case KeyboardKeyFunc_Leap.Function.UNDEFINED:
                    {
        ...
        public void Enter()
        {
            if (SubmitOnEnter)
            {
                ...
                if (OnTextSubmitted != null)
                {
                    ...
                    OnTextUpdated(this.gameObject, InputField.text);
